...
# (revenue, eps, op_income, ocf, capex, shares, debt), and the statement views
# (migration 0006) map them onto sectioned income-statement / balance-sheet /
# cash-flow line items; keep all three in sync.
CURATED_TAGS: dict[str, tuple[str, ...]] = {
    "us-gaap": (
        ...
        # Income statement — taxes & net income.
        ...
        # Balance sheet — current assets (instant facts).
        ...
        # Cash flow — operating (FCF = operating cash flow - capex).
